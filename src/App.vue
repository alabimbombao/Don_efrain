      ...
      <q-page class="page-content q-pa-md">
        <div class="row q-col-gutter-md q-mb-md">
          ...
          <div class="col-6 col-sm-3">
            <q-card flat class="stat-card">
              <q-card-section class="q-pa-sm text-center">
                <div class="text-caption text-grey-7">Total abonado</div>
        ...
        <div class="row items-center justify-between q-mb-md control-bar q-pa-sm">
          <div class="row items-center q-gutter-sm q-px-xs">
            <div class="text-subtitle1 text-weight-bold text-grey-9">
              Servicios Registrados ({{ obtenerServiciosFiltrados().length }})
            </div>
            <q-badge color="indigo-1" text-color="indigo-9" class="q-px-md q-py-xs text-subtitle2 text-weight-bold shadow-1">
              Total acumulado en esta sección: ${{ formatearNumero(calcularTotalFiltrado()) }}
            </q-badge>
          </div>
            ...
            <q-card flat class="device-card">
              ...
              <q-card-section class="q-pb-xs">
                <div class="row items-center justify-between no-wrap">
                  ...
                  <q-badge color="grey-3" text-color="grey-9" class="q-px-sm q-py-xs">
                    {{ obtenerEtiquetaReparacion(servicio) }}
                  </q-badge>
                </div>
              </q-card-section>
              ...
              <q-card-section class="q-py-xs q-gutter-xs text-caption">
                ...
                <div
                  ...
                  class="text-negative text-caption text-weight-bold q-mt-xs"
        ...
        <q-card-section style="max-height: 70vh" class="scroll bg-white text-grey-9 q-pa-md">
          <q-form ref="formularioRef" class="q-gutter-md">
            <div class="row q-col-gutter-md">
              ...
              <div :class="formulario.tipoReparacion === 'otros' ? 'col-12 col-sm-6' : 'col-12 col-sm-6'">
                <q-select
              ...
              <div class="col-12 col-sm-6" v-if="formulario.tipoReparacion === 'otros'">
                <q-input
              ...
              <div class="col-12 col-sm-6" v-if="formulario.estadoPago === 'abono'">
                <q-input
                  ...
                  bg-color="white"
                  prefix="$"
                  :hint="`Falta por pagar: $${formatearNumero(Math.max(formulario.precio - (formulario.montoAbonado || 0), 0))}`"
                  :rules="[
...
function calcularTotalFiltrado() {
  ...
  return filtrados.reduce((total, s) => total + (Number(s.precio) || 0), 0)
}
...
function obtenerEtiquetaReparacion(servicio) {
  if (!servicio) return '—'
